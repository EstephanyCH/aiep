...
<body>
    ...
    <div class="container content pt-5">
        <div class="row">
            <div class="col-md-6">
                <h4><b><i class="glyphicon glyphicon-education">&nbsp;</i>Libro de ventas</b></h4>
            </div>
        ...
        <input type="date" id="start" name="trip-end"
            ...
            <button id="btnAccion" type="submit" name="filtrar" class="btn btn-primary">Buscar</button>
                ...
                <div>
                    <table class='table table-striped table-hover table-responsive mt-4'>
                        ...
                        <tbody>
                            ...
                            if (isset($_SESSION['fechaInicio'])&& isset($_SESSION['fechaFin']) )
                            {
                                $listaFacturas = getFacturas( $_SESSION['fechaInicio'], $_SESSION['fechaFin']);
                            }
                            else {
                            ...
                            if(count($listaFacturas) > 0){
                                foreach($listaFacturas as $factura)
                                {
                                    ...
                                    if($factura->getIdEstado()->getEstado() == 'emitido'){
                                        {
                                            echo "<tr>";
