        ...
        <div class="col-md-8">
            ...
            <form action="/proyectoFacturas/controlador/controladorProducto.php" method="POST">
                ...
                <div class="form-group  mb-3">
                    ...
                    <input type="text" class="form-control" name="codigo" id="txtCodigo" placeholder="Ingresa el código del producto">
                </div>

                <div class="form-group  mb-3">
                    <label for="txtRut">Nombre:</label>
                    <input type="text" class="form-control" name="nombre" id="txtNombre" placeholder="Ingresa el nombre del producto">
                </div>

                <div class="form-group  mb-3">
                    <label for="txtNombre1">Descripcion:</label>
                    <input type="text" class="form-control" name="descripcion" id="txtDescripcion" placeholder="Ingresa la descripción del producto">
                </div>

                <div class="form-group  mb-3">
                    <label for="txtNombre2">Unidad de medida:</label>
                    <input type="text" class="form-control" name="unidadMedida" id="txtUnidadMedida" placeholder="Ingresa la unidad de medida del producto">
                </div>

                <div class="form-group  mb-3">
                    <label for="txtApellido1">Precio unitario:</label>
                    <input type="text" class="form-control" name="precioUnitario" id="txtPrecio" placeholder="Ingresa el precio unitario del producto">
                </div>
                <div class="mt-3">
